// GROVE LOCAL PATCH (re-apply on re-vendor): adds `not(feature = "grove-test-support")` here, or this is dead code under clippy's feature — a hard error under -D warnings on macOS CI.
