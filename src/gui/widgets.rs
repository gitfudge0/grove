...
use super::metrics::{MONO_FONT, ROW_H, UI_FONT};
...
pub fn modal_panel<'a>(content: Element<'a, Msg>, width: f32) -> Element<'a, Msg> {
    container(content)
        .width(width)
...
pub fn keycap<'a>(inner: Element<'a, Msg>) -> Element<'a, Msg> {
    container(inner)
...
pub fn keycap_text<'a>(label: impl Into<String>, color: Color) -> Element<'a, Msg> {
    keycap(
        text(label.into())
            .font(MONO_FONT)
            .size(11)
...
/// "[↑↓] navigate").
pub fn footer_hint<'a>(key: &'static str, label: &'static str) -> Element<'a, Msg> {
    row![
...
pub fn footer_container<'a>(content: Element<'a, Msg>) -> Element<'a, Msg> {
    container(content)
...
pub fn modal_footer_hints<'a>(hints: &[(&'static str, &'static str)]) -> Element<'a, Msg> {
...
pub fn modal_footer_row<'a>(content: Element<'a, Msg>) -> Element<'a, Msg> {
...
pub fn modal_header<'a>(title: &str, accent: Color) -> Element<'a, Msg> {
...
pub fn modal_header_row<'a>(row_content: Element<'a, Msg>) -> Element<'a, Msg> {
...
pub fn palette_input_style(_t: &iced::Theme, _status: text_input::Status) -> text_input::Style {
    text_input::Style {
