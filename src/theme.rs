...
pub const MONOKAI: Theme = Theme {
    ...
    bg_highlight: rgb(0x3e, 0x3d, 0x32),
    fg: rgb(0xf8, 0xf8, 0xf2),
    fg_dark: rgb(0xcf, 0xcf, 0xc2),
...
pub const MATERIAL: Theme = Theme {
    ...
    bg_highlight: rgb(0x32, 0x32, 0x32),
    fg: rgb(0xee, 0xff, 0xff),
    fg_dark: rgb(0xb2, 0xcc, 0xd6),
    comment: rgb(0x54, 0x54, 0x54),
...
pub const ROSE_PINE_MOON: Theme = Theme {
    ...
    bg_highlight: rgb(0x39, 0x35, 0x52),
    fg: rgb(0xe0, 0xde, 0xf4),
    fg_dark: rgb(0x90, 0x8c, 0xaa),
    comment: rgb(0x6e, 0x6a, 0x86),
    blue: rgb(0x3e, 0x8f, 0xb0),
    cyan: rgb(0x9c, 0xcf, 0xd8),
    magenta: rgb(0xc4, 0xa7, 0xe7),
    green: rgb(0x9c, 0xcf, 0xd8),
    yellow: rgb(0xf6, 0xc1, 0x77),
...
pub const OCEANIC_NEXT: Theme = Theme {
    name: "oceanic-next",
    kind: ThemeKind::Dark,
    bg: rgb(0x1b, 0x2b, 0x34),
    bg_highlight: rgb(0x34, 0x3d, 0x46),
    fg: rgb(0xcd, 0xd3, 0xde),
    fg_dark: rgb(0xa7, 0xad, 0xba),
    comment: rgb(0x65, 0x73, 0x7e),
    blue: rgb(0x66, 0x99, 0xcc),
    cyan: rgb(0x5f, 0xb3, 0xb3),
    magenta: rgb(0xc5, 0x94, 0xc5),
    green: rgb(0x99, 0xc7, 0x94),
    yellow: rgb(0xfa, 0xc8, 0x63),
    red: rgb(0xec, 0x5f, 0x67),
};

pub const ICEBERG: Theme = Theme {
    name: "iceberg",
    kind: ThemeKind::Dark,
    bg: rgb(0x16, 0x18, 0x21),
    bg_highlight: rgb(0x1e, 0x20, 0x30),
    fg: rgb(0xc6, 0xc8, 0xd1),
    fg_dark: rgb(0x9a, 0x9c, 0xa5),
    comment: rgb(0x6b, 0x70, 0x89),
    blue: rgb(0x84, 0xa0, 0xc6),
    cyan: rgb(0x89, 0xb8, 0xc2),
    magenta: rgb(0xa0, 0x91, 0xd7),
    green: rgb(0xb4, 0xbe, 0x82),
    yellow: rgb(0xe2, 0xa4, 0x78),
    red: rgb(0xe2, 0x73, 0x78),
};

pub const ZENBURN: Theme = Theme {
    name: "zenburn",
    kind: ThemeKind::Dark,
    bg: rgb(0x3f, 0x3f, 0x3f),
    bg_highlight: rgb(0x4f, 0x4f, 0x4f),
    fg: rgb(0xdc, 0xdc, 0xcc),
    fg_dark: rgb(0xc0, 0xc0, 0xb0),
    comment: rgb(0x7f, 0x9f, 0x7f),
    blue: rgb(0x8c, 0xd0, 0xd3),
    cyan: rgb(0x93, 0xe0, 0xe3),
    magenta: rgb(0xdc, 0x8c, 0xc3),
    green: rgb(0x9f, 0xc5, 0x9f),
    yellow: rgb(0xf0, 0xdf, 0xaf),
...
pub const PAPERCOLOR_LIGHT: Theme = Theme {
    name: "papercolor-light",
    kind: ThemeKind::Light,
    bg: rgb(0xee, 0xee, 0xee),
    bg_highlight: rgb(0xd0, 0xd0, 0xd0),
    fg: rgb(0x44, 0x44, 0x44),
    fg_dark: rgb(0x58, 0x58, 0x58),
    comment: rgb(0x8a, 0x8a, 0x8a),
    blue: rgb(0x00, 0x5f, 0xaf),
    cyan: rgb(0x00, 0x5f, 0x87),
    magenta: rgb(0xaf, 0x00, 0x5f),
    green: rgb(0x00, 0x5f, 0x00),
    yellow: rgb(0x8a, 0x8a, 0x00),
    red: rgb(0xaf, 0x00, 0x00),
};
...
pub const TOMORROW: Theme = Theme {
    ...
    kind: ThemeKind::Light,
    bg: rgb(0xff, 0xff, 0xff),
    bg_highlight: rgb(0xef, 0xef, 0xef),
    fg: rgb(0x4d, 0x4d, 0x4c),
    fg_dark: rgb(0x8e, 0x90, 0x8c),
    comment: rgb(0x8e, 0x90, 0x8c),
    blue: rgb(0x42, 0x71, 0xae),
    cyan: rgb(0x3e, 0x99, 0x9f),
    magenta: rgb(0x89, 0x59, 0xa8),
...
pub const QUIET_LIGHT: Theme = Theme {
    ...
    bg_highlight: rgb(0xe4, 0xe4, 0xe4),
    fg: rgb(0x33, 0x33, 0x33),
    fg_dark: rgb(0x55, 0x55, 0x55),
    comment: rgb(0xaa, 0xaa, 0xaa),
    blue: rgb(0x4b, 0x69, 0xc6),
    cyan: rgb(0x75, 0x75, 0xe4),
    magenta: rgb(0x7a, 0x3e, 0x9d),
    green: rgb(0x44, 0x8c, 0x27),
    yellow: rgb(0xaa, 0x5d, 0x00),
    red: rgb(0xab, 0x46, 0x42),
};
...
pub const MATERIAL_LIGHTER: Theme = Theme {
    ...
    kind: ThemeKind::Light,
    bg: rgb(0xfa, 0xfa, 0xfa),
    bg_highlight: rgb(0xe7, 0xe7, 0xe8),
    fg: rgb(0x54, 0x60, 0x66),
    fg_dark: rgb(0x80, 0x86, 0x8a),
    comment: rgb(0x90, 0xa4, 0xae),
    blue: rgb(0x61, 0x82, 0xb8),
    cyan: rgb(0x39, 0xad, 0xb5),
    magenta: rgb(0x7c, 0x4d, 0xff),
    green: rgb(0x91, 0xb8, 0x59),
    yellow: rgb(0xff, 0xb6, 0x2c),
    red: rgb(0xe5, 0x39, 0x35),
};

pub const MIN_LIGHT: Theme = Theme {
    name: "min-light",
    kind: ThemeKind::Light,
    bg: rgb(0xff, 0xff, 0xff),
    bg_highlight: rgb(0xe8, 0xe8, 0xe8),
    fg: rgb(0x44, 0x44, 0x44),
    fg_dark: rgb(0x88, 0x88, 0x88),
    comment: rgb(0x99, 0x99, 0x99),
    blue: rgb(0x56, 0x87, 0xbf),
    cyan: rgb(0x3a, 0x7e, 0x6f),
    magenta: rgb(0xa0, 0x6b, 0xa0),
    green: rgb(0x7e, 0xa6, 0x6a),
    yellow: rgb(0xbc, 0x8c, 0x47),
    red: rgb(0xbc, 0x4f, 0x4a),
};
