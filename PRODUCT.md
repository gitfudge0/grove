...
4. **Colors stay consistent.** Grove uses fixed dark and light palettes. People can follow the system appearance or choose dark or light.
...
- Light and dark appearances are both supported, with the same semantic status colors.
